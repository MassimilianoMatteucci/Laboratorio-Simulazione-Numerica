...
void MeanMeasure(int Nblocks){
  ...
  if(count%(nstep/(Nblocks*10))==0){
    mean2_etot+=mean_etot[1]*mean_etot[1];
    mean2_kin+=mean_kin[1]*mean_kin[1];
    mean2_temp+=mean_temp[1]*mean_temp[1];
    mean2_pot+=mean_pot[1]*mean_pot[1];
    mean_etot[1]=0;
    mean_kin[1]=0;
    mean_temp[1]=0;
    mean_pot[1]=0;
  ...
  if(count==nstep/10){
    ...
    Epot << mean_pot[0]/Nblocks << " " << sqrt(abs(mean2_pot/Nblocks-pow(mean_pot[0]/Nblocks,2))/(Nblocks-1)) << endl;
    Ekin << mean_kin[0]/Nblocks << " " << sqrt(abs(mean2_kin/Nblocks-pow(mean_kin[0]/Nblocks,2))/(Nblocks-1))  << endl;
    Temp << mean_temp[0]/Nblocks << " " << sqrt(abs(mean2_temp/Nblocks-pow(mean_temp[0]/Nblocks,2))/(Nblocks-1)) << endl;
    Etot << mean_etot[0]/Nblocks << " " << sqrt(abs(mean2_etot/Nblocks-pow(mean_etot[0]/Nblocks,2))/(Nblocks-1)) << endl;
...
void ConfOld(void){ //Write final configuration
  ...
  cout << "Print configuration at time t-dt to file old.final " << endl << endl;
